      ...
      >
        ...
        <div style={{
          ...
          <p style={{ color: 'var(--text-dim)', marginBottom: 14 }}>
            본 약관은 마지막이야기 (이하 "서비스")의 이용 조건 및 절차, 운영자와 이용자 간의 권리·의무 및 개인정보 처리에 관한 사항을 규정합니다.
            회원 가입 시 본 약관에 동의한 것으로 간주합니다.
          </p>

          <SectionHeader>제1부. 이용약관</SectionHeader>
          ...
          <Article title="제5조 (연령 제한)" highlight>
            <div style={{ fontWeight: 700, color: 'var(--accent)', marginBottom: 4 }}>※ 연령 제한 안내</div>
            ① 본 서비스는 <b>만 14세 이상</b>만 이용할 수 있습니다.<br/>
            ② 만 14세 미만의 아동은 본 서비스를 이용할 수 없으며, 가입이 확인될 경우 계정이 즉시 삭제됩니다.<br/>
            ③ 본 제한은 개인정보보호법 제22조의2(아동의 개인정보 보호)에 따른 법정대리인 동의 절차 미구현으로 인한 조치입니다.<br/>
            ④ 향후 정식 서비스 전환 시 법정대리인 동의 절차를 도입하여 연령 기준을 조정할 수 있습니다.
          </Article>
          ...
          <Article title="제8조 (계정 관리)">
            ① 계정은 구글 계정으로 관리되므로, 구글 계정의 보안은 이용자 본인이 책임집니다.<br/>
            ② 계정 도용 등 보안 사고 발생 시 즉시 운영자에게 통보해야 합니다.<br/>
            ③ 통보 지연으로 인한 불이익에 대해 운영자는 책임지지 않습니다.
          </Article>

          <Article title="제9조 (서비스 이용 제한)">
            운영자는 이용자가 제7조를 위반한 경우 경고, 거래 제한, 일시 정지, 영구 정지, IP 차단 등의 조치를 취할 수 있습니다.
          </Article>

          <Article title="제10조 (회원 탈퇴 및 계정 삭제)" highlight>
            <div style={{ fontWeight: 700, color: 'var(--accent)', marginBottom: 4 }}>※ 탈퇴 절차</div>
            ① 이용자는 언제든지 운영자에게 요청하여 회원 탈퇴를 진행할 수 있습니다.<br/>
            ② 탈퇴 요청이 접수되면 운영자는 해당 이용자의 계정 및 캐릭터·인벤토리·로그 등 관련 데이터를 즉시 삭제하며, 복구되지 않습니다.<br/>
            ③ 다만 법령에서 보관을 요구하는 접속 기록 등은 관계 법령에서 정한 기간 동안 별도 보관 후 파기합니다.<br/>
            ④ 탈퇴 후 동일 구글 계정으로 재가입은 가능하나, 이전 캐릭터·자산은 복구되지 않습니다.
          </Article>

          <Article title="제11조 (무료 서비스 안내)" highlight>
          ...
          <Article title="제12조 (게임물 등급 분류 안내)" highlight>
            <div style={{ fontWeight: 700, color: '#ff9966', marginBottom: 4 }}>※ 게임물관리위원회 등급 분류 미통과 안내</div>
            ① 본 서비스는 현재 게임물관리위원회의 <b>등급 분류를 받지 않은 테스트 단계</b>입니다.<br/>
            ② 운영자는 정식 서비스 전환 시 게임물관리위원회에 등급 분류를 신청하여 관련 법령을 준수할 예정입니다.<br/>
          ...
          <Article title="제13조 (운영자의 면책)">
            ① 운영자는 천재지변, 서버 장애, 네트워크 문제, 제3자 서비스(구글 OAuth 등) 장애 등 불가항력으로 인한 서비스 중단에 대해 책임을 지지 않습니다.<br/>
          ...
          <Article title="제14조 (서비스 종료 및 데이터 초기화)">
          ...
          <Article title="제15조 (분쟁 해결 및 준거법)">
            ① 서비스 이용과 관련하여 분쟁이 발생한 경우 운영자와 이용자는 상호 협의를 통해 해결합니다.<br/>
            ② 협의가 이루어지지 않는 경우 대한민국 법령에 따라 처리합니다.<br/>
            ③ 본 약관에 관한 소송의 관할 법원은 민사소송법에 따릅니다.
          </Article>

          <SectionHeader>제2부. 개인정보처리방침</SectionHeader>

          <Article title="제16조 (수집하는 개인정보 항목)">
            운영자는 서비스 제공을 위해 아래 항목을 수집합니다.<br/>
            ① <b>구글 OAuth 로그인 시 자동 수집</b>
            <ul style={{ margin: '4px 0 0 18px', padding: 0 }}>
              <li>구글 계정 고유 식별자(sub)</li>
              <li>이메일 주소</li>
              <li>이름(표시명)</li>
            </ul>
            ② <b>서비스 이용 시 자동 생성</b>
            <ul style={{ margin: '4px 0 0 18px', padding: 0 }}>
              <li>접속 IP 주소, User-Agent(브라우저 정보)</li>
              <li>로그인 이력, 접속 시각</li>
              <li>게임 내 활동 로그 (캐릭터·아이템·거래 기록 등)</li>
              <li>채팅 메시지 내용 (오남용 감지 목적)</li>
            </ul>
          </Article>

          <Article title="제17조 (개인정보의 이용 목적)">
            수집된 개인정보는 아래 목적으로만 이용됩니다.<br/>
            ① 이용자 식별 및 계정 관리<br/>
            ② 서비스 제공 및 기능 개선<br/>
            ③ 악성 행위 (해킹·어뷰징·다계정 악용 등) 탐지 및 차단<br/>
            ④ 분쟁 해결 및 민원 처리<br/>
            ⑤ 관계 법령에 따른 의무 이행
          </Article>

          <Article title="제18조 (개인정보의 보유 및 이용 기간)">
            ① 회원 탈퇴 요청 시 즉시 계정 및 관련 데이터를 삭제합니다.<br/>
            ② 다만 아래 법령상 의무에 따라 일정 기간 보관 후 파기합니다.
            <ul style={{ margin: '4px 0 0 18px', padding: 0 }}>
              <li>통신비밀보호법에 따른 로그 기록: 3개월</li>
              <li>정보통신망법에 따른 접속 기록: 3개월</li>
              <li>부정 이용 기록(제재·차단 이력): 1년</li>
            </ul>
          </Article>

          <Article title="제19조 (개인정보의 제3자 제공)">
            ① 운영자는 이용자의 개인정보를 제3자에게 제공하지 않습니다.<br/>
            ② 다만 아래 경우 예외적으로 제공할 수 있습니다.
            <ul style={{ margin: '4px 0 0 18px', padding: 0 }}>
              <li>이용자의 사전 동의가 있는 경우</li>
              <li>법령의 규정 또는 수사 목적의 영장에 의한 경우</li>
            </ul>
          </Article>

          <Article title="제20조 (개인정보의 처리 위탁)">
            ① 서비스 운영을 위해 아래 업체에 일부 처리를 위탁합니다.
            <ul style={{ margin: '4px 0 0 18px', padding: 0 }}>
              <li>Railway (서버 인프라·데이터베이스 호스팅)</li>
              <li>Google (OAuth 인증)</li>
            </ul>
            ② 운영자는 위탁 업체와의 계약 시 개인정보 보호 관련 법령 준수 의무를 명시합니다.
          </Article>

          <Article title="제21조 (이용자의 권리)">
            이용자는 운영자에 대해 아래 권리를 행사할 수 있습니다.<br/>
            ① 개인정보 열람·정정·삭제 요청<br/>
            ② 처리 정지 요청<br/>
            ③ 회원 탈퇴<br/>
            요청 접수는 서비스 내 문의 채널 또는 운영자 이메일로 가능합니다.
          </Article>

          <Article title="제22조 (쿠키 및 로컬 스토리지 사용)">
            ① 본 서비스는 로그인 유지 및 이용자 설정 저장 목적으로 브라우저 로컬 스토리지(localStorage) 및 세션 토큰을 사용합니다.<br/>
            ② 이용자는 브라우저 설정에서 로컬 스토리지를 삭제할 수 있으나, 이 경우 로그인 상태가 해제됩니다.
          </Article>
...
function SectionHeader({ children }: { children: React.ReactNode }) {
  return (
    <div style={{
      marginTop: 16, marginBottom: 10, paddingBottom: 6,
      borderBottom: '2px solid var(--accent)',
      fontSize: 15, fontWeight: 800, color: 'var(--accent)', letterSpacing: 1,
    }}>
      {children}
    </div>
  );
