                  ...
                  <div className="inv-item-header" style={{ display: 'flex', alignItems: 'center', gap: 6, paddingRight: 80 }}>
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      {!isExpanded && s.prefixStats && Object.keys(s.prefixStats).length > 0 && (
                        <div style={{ marginTop: 2 }}>
                          <PrefixDisplay prefixStats={s.prefixStats} prefixTiers={(s as any).prefixTiers} uniquePrefixStats={(s as any).uniquePrefixStats} enhanceLevel={s.enhanceLevel} />
                        </div>
                      )}
                    </div>
                          ...
                          <div style={{ padding: 8, background: 'rgba(218,165,32,0.05)', border: '1px solid rgba(218,165,32,0.2)', borderRadius: 4 }}>
                            ...
                            {eqItem ? (
                              <>
                                ...
                                <PrefixDisplay prefixStats={eqItem.prefixStats} prefixTiers={(eqItem as any).prefixTiers} uniquePrefixStats={(eqItem as any).uniquePrefixStats} enhanceLevel={(eqItem as any).enhanceLevel} />
                              </>
                            ) : (
