...
const SIGNATURE_BY_CLASS: Record<string, SignatureEntry[]> = {
  ...
  rogue: [
    {
      name: '독의 공명',
      desc: '독·출혈 도트 부여 시 공명 게이지 +1 (최대 10). 10 도달 시 다음 공격에 공명 폭발 (도트 폭딜) + 그림자 분신도 함께 폭발 (본체 폭발의 50% 데미지). 폭발 후 게이지 0 리셋.',
    },
    {
      name: '치명의 일격',
  ...
  summoner: [
    {
      name: '소환 폭주',
      desc: '60초마다 자동 발동. 발동 시 30초 동안 본체 스킬 쿨다운 −25%, 마공 +25% (최종 곱). 활성 종료 후 30초 대기 → 재발동.',
    },
  ],
  archer: [
    {
