          ...
          <div style={{ marginBottom: 6 }}>
            ...
            {a.prefixStats && Object.keys(a.prefixStats).length > 0 && (
              <div style={{ marginTop: 6 }}>
                ...
                <PrefixDisplay prefixStats={a.prefixStats} prefixTiers={(a as any).prefixTiers} uniquePrefixStats={(a as any).uniquePrefixStats} enhanceLevel={(a as any).enhanceLevel} />
              </div>
            )}
                ...
                <div style={{ marginTop: 8, padding: 8, background: 'rgba(218,165,32,0.05)', border: '1px solid rgba(218,165,32,0.25)', borderRadius: 4 }}>
                  ...
                  {eq.prefixStats && Object.keys(eq.prefixStats).length > 0 && (
                    <div style={{ marginTop: 4 }}>
                      <PrefixDisplay prefixStats={eq.prefixStats} prefixTiers={eq.prefixTiers} uniquePrefixStats={(eq as any).uniquePrefixStats} enhanceLevel={(eq as any).enhanceLevel} />
                    </div>
                  )}
      ...
      {sel && (
        <div style={{
          ...
          {sel.prefixStats && Object.keys(sel.prefixStats).length > 0 && (
            <PrefixDisplay prefixStats={sel.prefixStats} prefixTiers={(sel as any).prefixTiers} uniquePrefixStats={(sel as any).uniquePrefixStats} enhanceLevel={(sel as any).enhanceLevel} />
          )}
