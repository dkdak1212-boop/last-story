      ...
      <div style={{ borderRadius: 8, overflow: 'hidden', border: '1px solid var(--border)' }}>
        ...
        {tipsOpen && (
          <div style={{ padding: 16, background: 'var(--bg-panel)', fontSize: 12, color: 'var(--text-dim)' }}>
            ...
            <div>· 회피 상한 70% / 명중 기본 80% + 민첩 보정 (상한 100%)</div>
            ...
            <div>· 강화 공식 (파괴 없음): +1~3 100% / +4~6 80% / +7~9 50%</div>
            <div>· +10~12 30% / +13~15 20% / +16~18 10% / +19~20 5%</div>
            <div>· +21~+30 항상 1% (실패 누적 +0.1%, 성공 시 리셋, 스크롤 X)</div>
            <div>· 강화 스탯 누적: +1~10 +5%/단계, +11~20 +10%/단계, +21~30 +15%/단계 (최대 +30, ×4.0)</div>
