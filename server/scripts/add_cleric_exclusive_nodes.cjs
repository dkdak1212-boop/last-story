...
const GUARD_NODES = [
  // T1 작은 7개
  { name: '신성한 살결 1', tier: 'small', cost: 1, effects: [{ key: 'hp_flat', type: 'passive', value: 60 }], x: -20, y: -32 },
  { name: '신성한 살결 2', tier: 'small', cost: 1, effects: [{ key: 'hp_flat', type: 'passive', value: 60 }], x: -18, y: -32 },
  { name: '신성한 살결 3', tier: 'small', cost: 1, effects: [{ key: 'hp_flat', type: 'passive', value: 60 }], x: -16, y: -32 },
  { name: '굳건한 신앙 1', tier: 'small', cost: 1, effects: [{ key: 'hp_flat', type: 'passive', value: 80 }], x: -14, y: -32 },
  { name: '굳건한 신앙 2', tier: 'small', cost: 1, effects: [{ key: 'hp_flat', type: 'passive', value: 80 }], x: -12, y: -32 },
  { name: '강건한 의지 1', tier: 'small', cost: 1, effects: [{ stat: 'vit', type: 'stat', value: 6 }], x: -20, y: -30 },
  { name: '강건한 의지 2', tier: 'small', cost: 1, effects: [{ stat: 'vit', type: 'stat', value: 6 }], x: -18, y: -30 },
  // T2 중간 5개
  { name: '회복의 손길 1', tier: 'medium', cost: 2, effects: [{ key: 'heal_amp', type: 'passive', value: 15 }], x: -16, y: -30 },
  { name: '회복의 손길 2', tier: 'medium', cost: 2, effects: [{ key: 'heal_amp', type: 'passive', value: 15 }], x: -14, y: -30 },
  { name: '자가 치유', tier: 'medium', cost: 2, effects: [{ key: 'heal_amp', type: 'passive', value: 25 }], x: -12, y: -30 },
...
const RADIANT_NODES = [
  // T1 작은 7개
  { name: '광명의 의지 1', tier: 'small', cost: 1, effects: [{ key: 'hp_flat', type: 'passive', value: 60 }], x: 6, y: -32 },
  { name: '광명의 의지 2', tier: 'small', cost: 1, effects: [{ key: 'hp_flat', type: 'passive', value: 60 }], x: 8, y: -32 },
  { name: '광명의 의지 3', tier: 'small', cost: 1, effects: [{ key: 'hp_flat', type: 'passive', value: 60 }], x: 10, y: -32 },
  { name: '빛의 가속 1', tier: 'small', cost: 1, effects: [{ stat: 'spd', type: 'stat', value: 10 }], x: 12, y: -32 },
  { name: '빛의 가속 2', tier: 'small', cost: 1, effects: [{ stat: 'spd', type: 'stat', value: 10 }], x: 14, y: -32 },
  { name: '신성한 결의 1', tier: 'small', cost: 1, effects: [{ stat: 'cri', type: 'stat', value: 3 }], x: 6, y: -30 },
  { name: '신성한 결의 2', tier: 'small', cost: 1, effects: [{ stat: 'cri', type: 'stat', value: 3 }], x: 8, y: -30 },
  // T2 중간 5개
  { name: '신성 권능 1', tier: 'medium', cost: 2, effects: [{ key: 'judge_amp', type: 'passive', value: 10 }], x: 10, y: -30 },
  { name: '신성 권능 2', tier: 'medium', cost: 2, effects: [{ key: 'judge_amp', type: 'passive', value: 10 }], x: 12, y: -30 },
  { name: '빠른 시전', tier: 'medium', cost: 2, effects: [{ stat: 'spd', type: 'stat', value: 100 }], x: 14, y: -30 },
