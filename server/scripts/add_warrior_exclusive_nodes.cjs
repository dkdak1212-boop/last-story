...
const BERSERK_NODES = [
  // T1 작은 7개
  { name: '격노의 근력 1', tier: 'small', cost: 1, effects: [{ stat: 'str', type: 'stat', value: 4 }], x: -20, y: -32 },
  { name: '격노의 근력 2', tier: 'small', cost: 1, effects: [{ stat: 'str', type: 'stat', value: 4 }], x: -18, y: -32 },
  { name: '격노의 근력 3', tier: 'small', cost: 1, effects: [{ stat: 'str', type: 'stat', value: 4 }], x: -16, y: -32 },
  { name: '격노의 일격 1', tier: 'small', cost: 1, effects: [{ key: 'paragon_atk_pct', type: 'passive', value: 2 }], x: -20, y: -30 },
  { name: '격노의 일격 2', tier: 'small', cost: 1, effects: [{ key: 'paragon_atk_pct', type: 'passive', value: 2 }], x: -18, y: -30 },
  { name: '격노의 예감 1', tier: 'small', cost: 1, effects: [{ stat: 'cri', type: 'stat', value: 3 }], x: -16, y: -30 },
  { name: '격노의 예감 2', tier: 'small', cost: 1, effects: [{ stat: 'cri', type: 'stat', value: 3 }], x: -14, y: -30 },
  // T2 중간 5개
  { name: '출혈 강화 1', tier: 'medium', cost: 2, effects: [{ key: 'bleed_amp', type: 'passive', value: 15 }], x: -20, y: -28 },
  { name: '출혈 강화 2', tier: 'medium', cost: 2, effects: [{ key: 'bleed_amp', type: 'passive', value: 15 }], x: -18, y: -28 },
  { name: '깊은 상처', tier: 'medium', cost: 2, effects: [{ key: 'dot_duration_bonus', type: 'passive', value: 1 }], x: -16, y: -28 },
...
const GUARD_NODES = [
  // T1 작은 7개
  { name: '강철의 살결 1', tier: 'small', cost: 1, effects: [{ key: 'hp_flat', type: 'passive', value: 50 }], x: 6, y: -32 },
  { name: '강철의 살결 2', tier: 'small', cost: 1, effects: [{ key: 'hp_flat', type: 'passive', value: 50 }], x: 8, y: -32 },
  { name: '강철의 살결 3', tier: 'small', cost: 1, effects: [{ key: 'hp_flat', type: 'passive', value: 50 }], x: 10, y: -32 },
  { name: '굳건한 의지 1', tier: 'small', cost: 1, effects: [{ key: 'hp_flat', type: 'passive', value: 80 }], x: 12, y: -32 },
  { name: '굳건한 의지 2', tier: 'small', cost: 1, effects: [{ key: 'hp_flat', type: 'passive', value: 80 }], x: 14, y: -32 },
  { name: '강건한 체력 1', tier: 'small', cost: 1, effects: [{ stat: 'vit', type: 'stat', value: 5 }], x: 6, y: -30 },
  { name: '강건한 체력 2', tier: 'small', cost: 1, effects: [{ stat: 'vit', type: 'stat', value: 5 }], x: 8, y: -30 },
  // T2 중간 5개
  { name: '견고한 방어 1', tier: 'medium', cost: 2, effects: [{ stat: 'vit', type: 'stat', value: 10 }], x: 10, y: -30 },
  { name: '견고한 방어 2', tier: 'medium', cost: 2, effects: [{ stat: 'vit', type: 'stat', value: 12 }], x: 12, y: -30 },
  // 도발 메커니즘이 게임에 없어 '도발의 의지'(방어 강화)로 변경. 비슷한 컨셉으로 활력 +15 부여.
  { name: '도발의 의지', tier: 'medium', cost: 2, effects: [{ stat: 'vit', type: 'stat', value: 15 }], x: 14, y: -30 },
